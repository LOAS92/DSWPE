...
<body id="cuerpo">
    <div id="barra-logo">
	    ...
	    <div id="menu-vertical">
            ...
            <h1 class="encabezado"><a href="catalogo2.php">CATALOGO </a></h1>
	...
	<dt><a><span>ACCESORIOS</span></a></dt>
		<dd>
			<ul>
				...
				<li><a   href="accesorios2.php">ACCESORIOS PARA PERROS</a></li>
				<li><a  href="accesoriosgato2.php">ACCESORIOS PARA GATOS</a></li>
	...
	<dt><a><span>ROPA</span></a></dt>
		<dd>
			<ul>
				...
				<li><a href="ropaperro2.php">ROPA PARA PERROS</a></li>
				<li><a href="ropagato2.php">ROPA PARA GATOS</a></li>
     ...
     <h1 class="encabezado2"><a href="inicio_cliente.php">INICIO </a></h1>
        ...
        <ul id="slider" class="slider-wrapper">
            <li class="slide-current">
                ...
                <img src="imagenes/imagenes slider/4.jpg" alt="slider imagen1">
                <div class="caption">
                    
                    <h3 class="caption-title">ARENERO</h3>
                    <P>PARA QUE TU GATO NO ENSUCIE MAS DE LA CUENTA
                    </P>
                </div>
              ...
              <li>
                ...
                <img src="imagenes/imagenes slider/5.jpg" alt="slider imagen1">
                <div class="caption">
                    
                    <h3 class="caption-title">JUEGO EN EL AIRE</h3>
                    <P>TU MASCOTA SENTIRA QUE VOLARA</P>
                </div>
         ...
         <li>
                ...
                <img src="imagenes/imagenes slider/6.jpg" alt="slider imagen1">
                <div class="caption">
                    
                    <h3 class="caption-title">PECHERA</h3>
                    <P>LA MEJOR COMODIDAD EN EL MERCADO</P>
                </div>
