...
<div id="contenedor"> <h5 class="titulo" align="justify">
  ...
  &nbsp; &nbsp; &nbsp; ¡COMPARTE LA FOTO DE TU MASCOTA!<br><br>
  Este apartado es para que agregues y compartas la foto de tu mascota.
  <div id="texto" align="center">
					 </div>
			<justify>    
	   <FORM ACTION="carga_foto2.php" method="post" enctype="multipart/form-data" name="form1"> 
