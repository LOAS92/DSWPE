    ...
    <div id="barra-logo">
		...
		<div class="detalles">	
			<center>
				...
				<span class="span1"><?php echo utf8_encode($f['nombre']);?></span><br><br>
				<span class="span2">Precio $<?php echo utf8_encode($f['precio']);?></span><br><br>
				<span class="span">Descripcion:  <?php echo utf8_encode($f['descripcion']);?></span><br><br>
				<a href="./carrito2.php?id=<?php echo $f['id'];?>">Añadir al  carrito de  compras</a>
			</center>
		</div>
		<?php
