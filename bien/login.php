  ...
  <script type="text/javascript" src="js/jquery-2.1.3.min.js"></script>
	...
	<script language="javascript">
        function pregunta(){
		 ...
		 var pregunta ="¿Está seguro de que quiere guardar la información ";
		var respuesta ;
		...
		else if (!exptelefono.exec(tel.value))
		{
		 alert("el campo telefono solo acepta numeros y debe tener 10 digitos");
		 tel.focus()
		 verificar = false;
		}
    ...
    <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
		  ...
		  <input type="hidden" name="venta" value="<?php echo $mensaje ?>"/>
