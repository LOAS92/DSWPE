...
<body id="cuerpo">
    <div id="barra-logo">
		...
		<dl class="dropdown">
	<dt><a><span>DETALLES</span></a></dt>
		<dd>
			<ul>
				<li><a class="default">DETALLES</a></li>
				<li><a  href="catalogo.php" >REGREASR A CATALOGO</a></li>
				<li><a href="novedades.php">IR A NOVEDADES</a></li>
